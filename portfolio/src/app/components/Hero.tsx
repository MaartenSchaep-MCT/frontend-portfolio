    ...
    <div className="py-13 flex items-center justify-center gap-09">
          ...
          <ActionLink
            ...
            icon={
              <svg
                ...
                className="lucide lucide-download-icon lucide-download w-4 h-4"
              >
                <path
                  d="M12 15V3"
                  className="arrow"
      ...
      <div className="relative">
        ...
        <svg
          ...
          strokeLinecap="round"
          strokeLinejoin="round"
          className="lucide lucide-hand-icon lucide-hand origin-center opacity-0 absolute w-10 h-10 top-[10%] right-[20%]"
          style={waveStyle}
        >
